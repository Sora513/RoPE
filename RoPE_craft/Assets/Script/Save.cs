...
public class Save : MonoBehaviour
{
    ...
    IEnumerator ShotPNG()
    {
        GameObject SmallWindowObject = Camera.main.transform.GetChild(0).gameObject;
        SmallWindowObject.SetActive(false);

        GameObject Canvas = GameObject.Find("Canvas");
        Canvas.SetActive(false);

        ScreenCapture.CaptureScreenshot(Application.dataPath + "/RobotSave/" + Name + ".png");

        yield return null;

        SmallWindowObject.SetActive(true);
